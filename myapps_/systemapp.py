...
selectdept_combobox = ttk.Combobox(fr2,width=20,font=("Helvetica", 14) ,values=list(deptm.keys()),state="readonly")
selectdept_combobox.pack()
selectdept_combobox.bind("<<ComboboxSelected>>", update_options)


option_combobox = ttk.Combobox(fr2, width=20, font=("Helvetica", 14),state="readonly")
